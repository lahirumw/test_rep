      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
            <span class="sr-only">Toggle navigation 2</span>
    ...
    <div class="container">
      ...
      <div class="col-md-12 jumbotron topJumbo">
       <form name="search_item" id="search_item" method="POST" action="search_item.php">
		<div class="col-md-10">
			<input type="text" id="search_main" name="search_main" class="form-control" placeholder="Search term" value="<?php echo htmlentities($search_main); ?>">
		</div>
		<div class="col-md-2">
      ...
      <div class="row marketing">
                    ...
                    <div class="panel-body">
						<div class="col-md-12 divPad">
							<div class="form-group">
								<select class="form-control" id="cond" name="cond" value="<?php echo htmlentities($cond); ?>">
									<option></option>
									<option>New</option>
		...
		<?php 
			$ad_set = get_myAd_search($search_main, $cond, $loc, $vehi, $item);
